...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
let resultado = [];
for(contador = 0; contador < 11; contador = contador + 1){
  resultado.push(contador * 6);
}   //Se usa el return fuera del bucle for para que devuelva de una todo el conjunto numerico y no uno por uno.   
return(resultado);
  }
